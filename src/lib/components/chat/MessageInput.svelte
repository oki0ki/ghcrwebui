                                ...
                                <div class="">
                                        ...
                                        >
                                                ...
                                                <div
                                                        ...
                                                        class="flex-1 flex flex-col relative w-full rounded-xl border {$temporaryChatEnabled
                                                                ? 'border-dashed border-gray-200 dark:border-gray-700'
                                                                : 'border-gray-200 dark:border-gray-700'} transition px-1 bg-white dark:bg-gray-700 dark:text-gray-100"
